...
class BRANDDETAIL implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BRAND_DETAIL';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('brand_addr', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getBrandAddr()
    {
        return $this->container['brand_addr'];
    }

    /**
     * Sets brand_addr
     *
     * @param string|null $brand_addr Address of brand
     *
     * @return self
     */
    public function setBrandAddr($brand_addr)
    {
        if (is_null($brand_addr)) {
            array_push($this->openAPINullablesSetToNull, 'brand_addr');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('brand_addr', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['brand_addr'] = $brand_addr;
     ...
     * Sets short_desc
     *
     * @param string|null $short_desc Brand short description
     *
     * @return self
     */
     ...
     * Sets description
     *
     * @param string|null $description Brand description
     *
     * @return self
     */
     ...
     * Sets service_guide
     *
     * @param string|null $service_guide Describe the brand's terms of reference (T&C). HTML format
     *
     * @return self
     */
