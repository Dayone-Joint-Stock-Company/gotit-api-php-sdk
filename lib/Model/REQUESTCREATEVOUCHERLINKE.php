...
/**
 * REQUESTCREATEVOUCHERLINKE Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class REQUESTCREATEVOUCHERLINKE implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'REQUEST_CREATE_VOUCHER_LINK_E';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['use_otp'] === null) {
            $invalidProperties[] = "'use_otp' can't be null";
        }
     ...
     * Sets amount
     *
     * @param int $amount + Voucher value. Ensures the following conditions: + Is a multiple of 1000 + Is within the price range minimum - maximum value that the partner and Got It have agreed upon.
     *
     * @return self
     */
     ...
     * Sets product_id
     *
     * @param int|null $product_id + Product code. Specify the template displayed on the voucher (list of Categories and Brands). + If no transmission will use Got It's default productId
     *
     * @return self
     */
     ...
     * Sets use_otp
     *
     * @param int $use_otp = 1 if the end user is required to enter a password to view the voucher. Example: 1
     *
     * @return self
     */
     ...
     * Sets signature
     *
     * @param string $signature RSA encryption, used for client authentication
     *
     * @return self
     */
