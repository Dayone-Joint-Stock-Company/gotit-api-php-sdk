...
/**
 * STOREPAGINGSCHEMA Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class STOREPAGINGSCHEMA implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'STORE_PAGING_SCHEMA';
    ...
    */
     ...
     * Sets page_size
     *
     * @param int|null $page_size Size of page
     *
     * @return self
     */
     ...
     * Sets total_page
     *
     * @param int|null $total_page Total page
     *
     * @return self
     */
    public function setTotalPage($total_page)
    {
        if (is_null($total_page)) {
            array_push($this->openAPINullablesSetToNull, 'total_page');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('total_page', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
